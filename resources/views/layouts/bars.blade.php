    ...
    <div class="sidebar pe-4 pb-3">
        <nav style="background: #28323A;" class="navbar bg-light navbar-light">
            ...
            <div class="navbar-nav w-100">
                <a href="dashboard" class="nav-item nav-link active" id="dashboard-link"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                <a href="#" class="nav-item nav-link" id="categories-link"><i class="fa fa-list me-2"></i>Categories</a>
                <a href="#" class="nav-item nav-link" id="tags-link"><i class="fa fa-tags me-2"></i>Tags</a>
                <a href="#" class="nav-item nav-link" id="wikis-link"><i class="fa fa-file-alt me-2"></i>Wikis</a>
            </div>
        </nav>
    </div>
</div>
...
<nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
    ...
    <div class="navbar-nav align-items-center ms-auto">
        ...
        <div class="nav-item dropdown">
            <a href="{{ route('admin.profile') }}" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                <img class="rounded-circle me-lg-2" src="img/user.png" alt=""
                    style="width: 40px; height: 40px;">
                <span class="d-none d-lg-inline-flex">{{ $user->name ?? 'N/A' }}</span>
            </a>
            <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
